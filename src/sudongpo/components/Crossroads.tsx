...
import { crossroads } from '@/sudongpo/data/crossroads';
import { useScrollReveal } from '@/sudongpo/hooks/useScrollReveal';
import type { Crossroad } from '@/sudongpo/data/crossroads';

/**
 * 命运的岔路口
 * 反事实历史模块：每个岔路口可在"真实历史"与"平行历史"之间切换
 * 平行历史状态以紫色 #6C3483 暗示平行宇宙的异样感
 */
        ...
        <div className="relative flex flex-col gap-6 sm:flex-row">
          ...
          <div className="sm:w-1/3 sm:shrink-0">
            <div className="flex items-baseline gap-2">
              ...
              <span className="font-sans text-xs text-[#f5e6d3]/40">
                岔路口 {String(index + 1).padStart(2, '0')}
              </span>
            </div>
            <h3 className="mt-3 font-serif text-xl font-bold text-[#f5e6d3]">
              {crossroad.title}
            </h3>
          </div>
          ...
          <div className="flex-1 border-t border-white/10 pt-4 sm:border-l sm:border-t-0 sm:pl-6 sm:pt-0">
            ...
            <button
              ...
              style={{
                ...
                color: isAlternate ? '#f5e6d3' : accentColor,
            ...
            <div className="relative min-h-[120px]">
              ...
              >
                <span className="font-sans text-[10px] tracking-wider text-[#f5e6d3]/50">
                  真实历史
                </span>
                <p className="mt-1.5 font-sans text-sm leading-relaxed text-[#f5e6d3]/85">
                  {crossroad.realHistory}
                </p>
              </div>
              ...
              >
                ...
                {/* 平行历史 */}
                <p className="font-sans text-xs italic leading-relaxed text-[#f5e6d3]/70">
                  {crossroad.altHistory}
                </p>
                ...
                >
                  <span className="font-sans text-[10px] tracking-wider text-[#c73e3a]/60">
                    连锁影响
                  </span>
                  <p className="mt-1 font-sans text-xs leading-relaxed text-[#f5e6d3]/65">
                    {crossroad.impact}
                  </p>
                </div>
              </div>
