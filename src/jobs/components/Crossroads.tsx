...
import { crossroads } from '@/jobs/data/crossroads';
import { useScrollReveal } from '@/jobs/hooks/useScrollReveal';
import type { Crossroad } from '@/jobs/data/crossroads';
    ...
    <section className="relative mx-auto max-w-5xl px-4 py-16 sm:px-6 sm:py-20">
      <div ref={ref} className={`reveal ${isVisible ? 'is-visible' : ''}`}>
        ...
        <div className="mb-12 text-center sm:mb-16">
          <p className="mb-2 font-sans text-xs tracking-[0.25em] text-[#C0C0C0] sm:mb-3 sm:text-sm sm:tracking-[0.3em]">CROSSROADS</p>
        ...
        <div className="relative flex flex-col gap-4 sm:gap-6 sm:flex-row">
          ...
          <div className="sm:w-1/3 sm:shrink-0">
            <div className="flex items-baseline gap-2">
              ...
              <span className="font-sans text-[10px] text-[#E5E7EB]/40 sm:text-xs">
                岔路口 {String(index + 1).padStart(2, '0')}
              </span>
            </div>
            <p className="mt-2 font-serif text-sm leading-relaxed text-[#E5E7EB]/75 sm:mt-3">
              {crossroad.moment}
            </p>
          </div>
          ...
          <div className="flex-1 border-t border-white/10 pt-4 sm:border-l sm:border-t-0 sm:pl-6 sm:pt-0">
            ...
            <button
              ...
              style={{
                ...
                color: isAlternate ? '#E5E7EB' : accentColor,
            ...
            <div className="relative min-h-[120px]">
              ...
              >
                <span className="font-sans text-[10px] tracking-wider text-[#E5E7EB]/50">
                  真实历史
                </span>
                <p className="mt-1.5 font-sans text-sm leading-relaxed text-[#E5E7EB]/85">
                  {crossroad.reality}
                </p>
              </div>
              ...
              >
                ...
                {/* 平行历史 */}
                <p className="font-sans text-xs italic leading-relaxed text-[#E5E7EB]/70">
                  {crossroad.alternate}
                </p>
                ...
                >
                  ...
                  <p className="mt-1 font-sans text-xs leading-relaxed text-[#E5E7EB]/65">
