...
import { crossroads } from '@/musk/data/crossroads';
import { useScrollReveal } from '@/musk/hooks/useScrollReveal';
import type { Crossroad } from '@/musk/data/crossroads';
          ...
          <div className="flex-1 border-t border-white/10 pt-4 sm:border-l sm:border-t-0 sm:pl-6 sm:pt-0">
            ...
            <button
              ...
              style={{
                ...
                color: isAlternate ? '#f1faee' : accentColor,
            ...
            <div className="relative min-h-[120px]">
              ...
              >
                <span className="font-sans text-[10px] tracking-wider text-[#f1faee]/50">
                  真实历史
                </span>
                <p className="mt-1.5 font-sans text-sm leading-relaxed text-[#f1faee]/85">
                  {crossroad.reality}
                </p>
              </div>
              ...
              >
                ...
                {/* 平行历史 */}
                <p className="font-sans text-xs italic leading-relaxed text-[#f1faee]/70">
                  {crossroad.alternate}
                </p>
                ...
                >
                  <span className="font-sans text-[10px] tracking-wider text-[#e63946]/60">
                    连锁影响
                  </span>
                  <p className="mt-1 font-sans text-xs leading-relaxed text-[#f1faee]/65">
