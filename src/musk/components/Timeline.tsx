    ...
    <section className="relative mx-auto max-w-7xl px-6 py-20">
      <div ref={ref} className={`reveal ${isVisible ? 'is-visible' : ''}`}>
        ...
        <div className="mb-16 text-center">
          <p className="mb-3 font-sans text-sm tracking-[0.3em] text-[#e63946]">TIMELINE</p>
      ...
      <div>
        ...
        <div className="mb-6 flex items-end justify-between border-b border-white/10 pb-4">
          <div>
            ...
            <p className="mt-3 font-sans text-sm text-[#f1faee]/50">{stage.description}</p>
          </div>
          <span className="font-serif text-lg font-medium text-[#f1faee]/40">{stage.period}</span>
        </div>
    ...
    >
      ...
      >
        <div className="flex flex-wrap items-center gap-x-3 gap-y-1">
          ...
          <span className="rounded bg-white/5 px-2 py-0.5 font-sans text-xs text-[#f1faee]/50">
            第{event.chapter}章
          </span>
          {isHigh && (
            <span
        ...
        <p className="mt-2 font-sans text-sm leading-relaxed text-[#f1faee]/85">
          {event.event}
        </p>
        {event.location && (
          <p className="mt-2 flex items-center gap-1 font-sans text-xs text-[#f1faee]/40">
